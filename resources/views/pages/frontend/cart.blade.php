                ...
                <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
                    <form action="{{ route('checkout') }}" method="post">
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <input data-input type="text" id="name" name="name" class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none" placeholder="Input your name" />
                        </div>
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <input data-input type="tel" id="phone" name="phone" class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none" placeholder="Input your phone number" />
                        </div>
